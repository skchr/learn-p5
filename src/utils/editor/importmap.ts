export const importMap: Record<string, string> = {
  ...
  "@codemirror/fold": "https://cdn.jsdelivr.net/npm/@codemirror/fold@6.2.1/+esm",
  ...
  "@codemirror/closebrackets": "https://cdn.jsdelivr.net/npm/@codemirror/closebrackets@6.3.2/+esm",
  "@codemirror/comment": "https://cdn.jsdelivr.net/npm/@codemirror/comment@6.5.2/+esm",
  "@codemirror/highlight": "https://cdn.jsdelivr.net/npm/@codemirror/highlight@6.1.0/+esm",
  ...
  "@lezer/javascript": "https://cdn.jsdelivr.net/npm/@lezer/javascript@1.4.22/+esm",
