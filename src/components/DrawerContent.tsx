...
const navItems: NavItem[] = [
  { label: "Dashboard", href: "/dashboard", icon: "󰨝 " },
  { label: "Learn", href: "/learn", icon: "󰚡 " },
  { label: "Playground", href: "/playground", icon: "󰘺 " },
  { label: "Reference", href: "/ref", icon: "󰭤 " },
  { label: "Settings", href: "/settings", icon: "󰢻 " },
  { label: "Support", href: "/support", icon: "󰋕 " },
  ...
  return (
    <View className="flex-1 bg-surface dark:bg-surface-dark">
      ...
      <View className="px-6 pt-6 pb-4">
        ...
        <View className="h-2 bg-surface-dim dark:bg-[#333] rounded-full mt-4 overflow-hidden">
      ...
      <View className="flex-1 pt-2">
        {navItems.map((item) => (
          ...
          >
            <Text
              className={`text-lg w-8 text-center ${isActive(item.href)
                ? "text-primary"
