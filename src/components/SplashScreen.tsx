...
export default function SplashScreen({ onFinish, loading }: SplashScreenProps) {
  ...
  useEffect(() => {
    ...
    scale.value = withTiming(1, { duration: 800, easing: Easing.out(Easing.circle) });
  }, []);
    ...
    <Animated.View style={[styles.container, animatedContainer]}>
      <Animated.View style={animatedLogo}>
        <Svg width={100} height={46} viewBox="0 0 250 114">
          {logoPaths.map((d, i) => (
            <Path key={`splash-path-${i}`} d={d} fill="#ED225D" />
          ))}
        </Svg>
      </Animated.View>
      <Text style={styles.title}>Learn p5.js</Text>
      <Text style={styles.subtitle}>Creative coding, made friendly</Text>
    </Animated.View>
  );
}
