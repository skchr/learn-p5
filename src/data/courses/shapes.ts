  ...
  lessons: [
    {
      ...
      validation: [{ type: "functionCall" as const, name: "circle", exactArgs: 3 }],
    },
    {
      id: "exercise-2",
      ...
      validation: [{ type: "functionCall" as const, name: "rect", exactArgs: 4 }],
    },
    {
      id: "exercise-3",
      ...
      validation: [{ type: "functionCall" as const, name: "ellipse", exactArgs: 4 }],
    },
    {
      id: "exercise-4",
      title: "Line Dance",
      ...
      startingCode: "function setup() {\n  createCanvas(400, 400);\n}\n\nfunction draw() {\n  background(15);\n  stroke(255, 100, 100);\n  strokeWeight(4);\n  \n}",
      solution: "function setup() {\n  createCanvas(400, 400);\n}\n\nfunction draw() {\n  background(15);\n  stroke(255, 100, 100);\n  strokeWeight(4);\n  line(0, 0, 400, 400);\n}",
      validation: [{ type: "functionCall" as const, name: "line", exactArgs: 4 }],
    },
    {
      id: "exercise-5",
      ...
      validation: [{ type: "functionCall" as const, name: "triangle", exactArgs: 6 }],
    },
    {
      id: "exercise-6",
      title: "Quad Squad",
      ...
      validation: [{ type: "functionCall" as const, name: "quad", exactArgs: 8 }],
    },
    {
      id: "exercise-7",
      title: "Arc Adept",
      ...
      validation: [{ type: "functionCall" as const, name: "arc", minArgs: 5 }],
    }
  ]
};
