  ...
  return (
    <View style={[styles.container, { backgroundColor: surface }]}>
      ...
      <View style={styles.body}>
        ...
        <Text style={[styles.title, { color: onSurface }]}>Learn p5.js</Text>
        <View style={[styles.versionBadge, { backgroundColor: surfaceDim }]}>
        ...
        <View style={styles.footer}>
          ...
          <Text style={[styles.footerMono, { color: textSecondary }]}>
